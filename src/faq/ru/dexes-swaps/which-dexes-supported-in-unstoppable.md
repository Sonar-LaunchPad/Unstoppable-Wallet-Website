# Which DEXes supported in StarBase?

StarBase wallet currently supports following decentralized exchanges:
...
In the near future, StarBase aims to complete integration with Thorchain (https://thorchain.org) decentralized exchange that enables cryptocurrency trades between blockchains for the first time.
