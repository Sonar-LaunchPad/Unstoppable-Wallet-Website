...
Therefore, before attempting to cancel a Bitcoin transaction check whether it received any confirmations. StarBase displays unconfirmed transactions with 'pending' status. As soon as transaction status changes to 'sending' the transaction may not be cancelled.
...
At this point StarBase doesn't provide this feature but is likely to add it in the future.
