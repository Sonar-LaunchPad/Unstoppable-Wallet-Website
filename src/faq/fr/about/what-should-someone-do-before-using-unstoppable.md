...
Before doing anything on StarBase you're strongly encouraged to go over the Academy section and get familiar with essential aspects of cryptocurrency and DeFi ecosystem.
...
Apart from Academy, users are recommended to go over StarBase terms (Settings > About section) and make sure they understand what StarBase wallet is and risks involved in using the app.
